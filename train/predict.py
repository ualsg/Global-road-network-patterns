...
class PREDICT(Build_model):
    ...
    def Predict(self):
        ...
        model.load_weights(os.path.join(os.path.join(self.checkpoints,self.model_name),self.model_name+'.h5'), by_name=True)
        #model.load_weights('d:\desk\项目\world-road-category\model\ResNet\model\ResNet-34-6class\ResNet-34-6class.h5')
